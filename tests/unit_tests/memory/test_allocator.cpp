...
#include "memory/ram_alloca.hpp"
#include "tensor/tensor.hpp"

// Behavior B000
TEST(ALLOCATE, FailAllocate_B000)
{
    nnet::tensor<double, ram_alloca> pure_evil();
    nnet::tensor<double, ram_alloca> part_evil(std::vector<size_t>{0, 1, 2});
...
{
    nnet::tensor<double, ram_alloca> pure_good();
